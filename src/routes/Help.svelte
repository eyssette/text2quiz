<script>
	...
	helpText[6] = ["Grille", "Grille || Catégorie 1|Catégorie 2 || {Énoncé 1 catégorie 1|Énoncé 2 catégorie 1}{Énoncé 1 catégorie 2|Énoncé 2 catégorie 2}", "On peut utiliser autant de catégories que l'on veut, mais la grille sera difficilement lisible au-delà de 3. Pour chaque catégorie, on met entre accolades les Énoncés qui correspondent à cette catégorie, séparés par une barre verticale : |"];
	...
	helpText[8] = ["Etiquettes", "Etiquettes || Catégorie 1|Catégorie 2 || {Étiquette 1 catégorie 1|Étiquette 2 catégorie 1}{Étiquette 1 catégorie 2|Étiquette 2 catégorie 1}", "On peut utiliser autant de catégories que l'on veut. Pour chaque catégorie, on met entre accolades : { } les étiquettes qui correspondent à cette catégorie, séparées par une barre verticale : |"];
