<script>
	...
	helpText[8] = ["Etiquettes", "Etiquettes || Catégorie 1|Catégorie 2 || {{Étiquette 1 catégorie 1|Étiquette 2 catégorie 1}}{{Étiquette 1 catégorie 2|Étiquette 2 catégorie 1}}", "On peut utiliser autant de catégories que l'on veut. Pour chaque catégorie, on met entre doublesaccolades : {{ }} les étiquettes qui correspondent à cette catégorie, séparées par une barre verticale : |"];
